...
const EXPECTED_MIGRATIONS = [
  ...
  {
    version: 92,
    filename: "0092_governed_party_profile_update.sql",
    checksum_sha256: "105ca27c2f4d7fcb4f8bb6dfb6eb28b5a8c615d80eb9b4d863a006497dd47dda",
  },
  {
    version: 93,
    filename: "0093_governed_synthetic_clean_arrival_reconciliation.sql",
    checksum_sha256: "c9201892e38bc8f3fbb55def457b7289e34cee126282d57a386580b1f0c21346",
  },
  {
    version: 94,
    filename: "0094_governed_synthetic_clean_arrival_account_reconciliation.sql",
    checksum_sha256: "867f54d3f94655fc5aa4b631433c37ed173aa20bb6e515f9df39d52e1c1b7c89",
  },
  {
    version: 95,
    filename: "0095_rate_policy_runtime_read.sql",
    checksum_sha256: "6ffb69469566ce3e5267f06f972ddba7ab0c99b7eafcf36287f3b1f953c186b0",
  },
  {
    version: 96,
    filename: "0096_governed_checkin_room_condition_lock.sql",
    checksum_sha256: "3d0c1b99445620ca972ccd971d94f5847d2c983e0eb0b2f6e2eb09ed02093f1a",
  },
  {
    version: 97,
    filename: "0097_governed_nonfiscal_folio_series_configuration.sql",
    checksum_sha256: "27ef8bf95f5ca18b54abb031298825ab6536f28a9ca1a0afbff762bba3b53dca",
  },
  {
    version: 98,
    filename: "0098_property_identity_profile.sql",
    checksum_sha256: "dc8472faebbd05c4ebd3baf34d6582e3a7bd9f370be0d1bc8afc66284db69e2a",
  },
  {
    version: 99,
...
databaseDescribe("fresh deployment database acceptance", () => {
  ...
  test("has the exact governed cashier schema, RLS and bounded capability authority", async () => {
    ...
    `;
    expect(shape).toEqual([{ tables: 130, policies: 120 }]);
  ...
  test("has exact journal approval lineage and governed receivable-transfer authority", async () => {
    ...
    expect(shape).toEqual([{
      tables: 130, policies: 120, directBill: 1,
