...
databaseRun("Order 367 fresh PostgreSQL integration", () => {
  ...
  test("has the exact current92 catalogue while preserving the canonical 0090 component proof", async () => {
    ...
    expect(actual).toEqual({
      migrations: 92, tables: 129, rls: 119, policies: 119, forced: 28, views: 2,
    });
  });
