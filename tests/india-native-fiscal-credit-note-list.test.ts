...
describe("native issued credit list", () => {
  test("detaches canonical inputs and rejects malformed selectors before SQL", async () => {
    ...
    const db = fake([]);
    for (const candidate of [{limit: 0}, {limit: 101}, {limit: "25"}, {limit: 1.5}, {issuedFrom: "2026-02-30"}, {issuedBefore: "2026-09-01"}, {issuedBefore: "2028-01-01"}, {docNo: "%"}, {docNo: ""}, {docNo: "\ud800"}, {after: ""}, {after: "e30="}, {actorId: actorId.toUpperCase()}, {unknown: true}]) {
      const extra: Record<string, unknown> = {...candidate};
