...
# Current source applies migrations 1-85: 127 application tables plus the
...
[ "$tables" = '128' ] || { printf 'yellow_test has %s public tables; expected 128 after migrations 1-85.\n' "$tables" >&2; exit 1; }
echo 'yellow_test tables: 128 after migrations 1-85'
