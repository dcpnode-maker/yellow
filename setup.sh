...
# Current source applies migrations 1-99: 129 application tables plus the
...
[ "$tables" = '130' ] || { printf 'yellow_test has %s public tables; expected 130 after migrations 1-99.\n' "$tables" >&2; exit 1; }
echo 'yellow_test tables: 130 after migrations 1-99'
