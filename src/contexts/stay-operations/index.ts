export {
  DepartureServiceCoordinationService, DepartureServiceError,
  DEPARTURE_SERVICE_KINDS, DEPARTURE_SERVICE_ACTIONS,
  normalizeDepartureServiceProposal, normalizeDepartureServiceAction,
} from "./departure-service-coordination";
export type {
  DepartureServiceKind, DepartureServiceAction, DepartureServiceOutcome, DepartureServiceProposal,
  DepartureServiceActionBody, DepartureServiceIdentity, DepartureServiceRequest,
} from "./departure-service-coordination";
