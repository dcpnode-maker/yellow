...
export type {
  ConfigureNonFiscalFolioSeriesInput,
  ConfigureNonFiscalFolioSeriesResult,
} from "./folio-series";
...
export type {
  ...
  FolioHostedDepositWorkbench,
  FolioHostedDepositWorkbenchInput,
  HostedDepositInstrument,
  HostedDepositLink,
  HostedDepositStatus,
} from "./hosted-deposits";
export type {
