...
**Updated:** 2026-09-05 · **Order:** 433 · **Authority:** founder requirements,
...
| YF-008 | Contextual cashier billing, append-only corrections, multiple folio windows and payer/invoice separation | 5, 7, 10 | [Cashier foundation](../src/contexts/financials/cashiers.ts), PROJECT invariants and existing financial orders govern. No deleted financial records; invoice eligibility is distinct from display grouping. Native fiscal issuance remains incomplete under Order430. |
