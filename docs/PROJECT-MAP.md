...
| What is being done, built or independently verified? | [Orders](../handoff/orders/), [reviews](../handoff/reviews/), [ledger](../handoff/LEDGER.md), exact commits/CI; [status source](../src/project-status.ts) is a recorded projection |
