# Question 138 — Order 112 second inherited exact-role proof drift
...
May Order 112 include these remaining two same-purpose exact-role assertions and
...
`tests/offline-leases.integration.test.ts` to Order 112 Scope. Preserve exact sorted
