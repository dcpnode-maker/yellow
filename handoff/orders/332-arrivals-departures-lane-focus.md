...
- [ ] Intentional red proves the existing control reloads/self-navigates rather than
      focusing the operational lanes.
- [ ] The exact control focuses the semantic lane target with no request or history
      change while all other seven journey identities preserve existing routing.
- [ ] Focused, standing and static gates pass.
