...
Reflect approved Order326 in the one loopback3000 app while preserving every
...
- retain approved Order325 stopped for rollback and inherit its exact network,
  loopback bind, health contract and environment;
- verify health, protected one-button login, two properties, 24 routes, truthful
  status, live Separate charges journey and unchanged database/companions/ports;
