...
## Receiving lineage note — 2026-09-09

The historical review above is preserved verbatim, including its statement that the
review used an admitted base `f3f07174408d8376485ecda019011f4e764bd051`.
For the current desktop receiving decision, a fresh read-only GitHub compare of exact
remote commit `d842750c1d43b1977efaf3bd36e46bc370f43d59` establishes the actual merge
base as PR92 head `547cf3d335afdcec7ae4b7d05517a2153b342d0e`: ahead by two, behind by zero,
with exactly the four Order461 paths added.  The local `origin/phase-7/operator-invoice-workflow`
ref and active HEAD were also both `547cf3d335afdcec7ae4b7d05517a2153b342d0e`;
the remote sandbox commit/object was not fetched into local Git.

Before these receiving notes were appended, the LF-only remote bytes were
materialized through `apply_patch` and independently matched SHA-256:

```text
handoff/orders/461-bounded-irp-sandbox-acceptance.md  1727c170cd390bfc07d4b488cf2e9dade91b97fa3637c266230e7cdeeea3da50
handoff/reviews/461-bounded-irp-sandbox-acceptance.md  5a2723e65e554cd30082f7d4dd918532f36e20f11a5e2544fa23be636ecb1a03
scripts/run-irp-sandbox-acceptance.ts                 d3b33800c7b95aa41ff9d699a968c6bef224c660b47c227c97435ac1648d8cf1
tests/irp-sandbox-acceptance.test.ts                  38daa0eaca22656f07f1b219ab64c6ec6945099bad6c4c17a92974c4a39c9df0
```

This note admits source-only receiving and does not broaden the earlier acceptance.
No native ACL proof, credential/provider configuration, external request, database,
runtime artifact, publication or Phase7 completion is claimed.
